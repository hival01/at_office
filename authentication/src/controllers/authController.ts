...
import { SessionUser } from "../middlewares/authMiddleware";
...
export function showRegisterPage(req: Request, res: Response): void {
...
export function showForgotPasswordPage(req: Request, res: Response): void {
...
export async function showHomePage(req: Request, res: Response): Promise<void> {
